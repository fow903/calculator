...
This project aims to be a strong foundation for react-native calculator. It provides a clear and organized structure, core dependencies.
...
Run the application deploying the metro server, and then you will need to run the following command
